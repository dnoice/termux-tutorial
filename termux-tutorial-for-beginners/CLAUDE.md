...
`termux-tutorial-for-beginners/`. Its parent is the MONOREPO ROOT, holding
the sibling courses, the shared `global-docs/`, and the one deploy workflow. `npm` commands run **here**, not there.
