...
export const LESSONS: Lesson[] = [
	{ slug: 'start/why-termux', title: 'Why Termux (not the Play Store)', section: 'Start Here' },
	{ slug: 'start/installing', title: 'Installing Termux Safely', section: 'Start Here' },
	{ slug: 'start/first-session', title: 'Your First Session', section: 'Start Here' },
	{ slug: 'start/friendly-shell', title: 'Upgrade Your Shell to Fish', section: 'Start Here' },
	{ slug: 'start/sessions-and-copy-paste', title: 'Sessions, Copy & Paste', section: 'Start Here' },
	{ slug: 'foundations/filesystem', title: 'Navigating the Filesystem', section: 'Foundations' },
	{ slug: 'foundations/files-and-folders', title: 'Files & Folders', section: 'Foundations' },
	{ slug: 'foundations/storage', title: 'Bridging Android Storage', section: 'Foundations' },
	{ slug: 'foundations/packages', title: 'Package Management with pkg', section: 'Foundations' },
	{ slug: 'foundations/extra-keys', title: 'Optimizing the Keyboard', section: 'Foundations' },
	{ slug: 'where-next', title: 'Where to Next', section: 'Foundations' },
];
 ...
 * equal: the advanced course shipped from this shape with EXPORT_KIND updated
 * and the interface still naming its source course — two of the three typecheck
 * errors that port carried. `typeof EXPORT_KIND` makes that unrepresentable:
 * one string, and the next port changes it once.
 *
 ...
 */
export const EXPORT_KIND = 'termux-beginners-progress' as const;
...
export function importProgress(json: string): ImportResult {
	...
	if (candidate.kind !== EXPORT_KIND) {
		return {
			ok: false,
			error: "That's a JSON file, but not a Termux for Beginners progress file.",
		};
	}
